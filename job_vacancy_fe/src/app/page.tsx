...
const JobVacanciesPage: React.FC = () => {
  ...
  return (
    <Container>
      <Typography variant="h4" style={{ marginTop: 15, marginBottom: 20 }} gutterBottom>Job Vacancies</Typography>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 10 }}>
        <div>
          ...
          <Button variant="contained" color="secondary" onClick={handleScrapingDialogOpen} style={{ marginRight: 10 }}>
            Scraping Data
          </Button>
